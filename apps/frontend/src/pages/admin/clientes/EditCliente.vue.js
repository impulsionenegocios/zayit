...
const { name, nameError, blurName, nameMeta, email, emailError, blurEmail, emailMeta, password, passwordError, blurPassword, passwordMeta, logo, salvar, carregarClienteParaEdicao, existingLogoUrl, removeExistingLogo, carregando, role, roleError, roleMeta, blurRole, roles, } = useClienteForm(clienteId);
