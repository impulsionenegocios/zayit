...
const __VLS_53 = __VLS_asFunctionalComponent(
  ...
  new BaseFileInput({
    ...
    existingFileUrl: __VLS_ctx.verifyExistingLogoUrl,
    name: 'logo',
    multiple: false,
    autoUpload: false,
...
let __VLS_58;
const __VLS_59 = {
  onFileRemoved: __VLS_ctx.removeExistingLogo,
};
var __VLS_55;
var __VLS_52;
var __VLS_49;
...
var __VLS_2;
/** @type {__VLS_StyleScopedClasses['px-8']} */ /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['justify-end']} */ /** @type {__VLS_StyleScopedClasses['gap-4']} */ /** @type {__VLS_StyleScopedClasses['mt-6']} */ /** @type {__VLS_StyleScopedClasses['btn-default']} */ /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-success']} */ /** @type {__VLS_StyleScopedClasses['btn']} */ var __VLS_dollars;
const __VLS_self = (await import('vue')).defineComponent({
  setup() {
    return {
      ...
      blurRole: blurRole,
      roles: roles,
      verifyExistingLogoUrl: verifyExistingLogoUrl,
      voltar: voltar,
    };
  },
});
