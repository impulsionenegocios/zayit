...
/** @type {[typeof DocBlock, typeof DocBlock, ]} */ // @ts-ignore
const __VLS_0 = __VLS_asFunctionalComponent(
  DocBlock,
  new DocBlock({
    title: 'Tabela básica com ações',
    description:
      'Tabela com seleção múltipla, busca, slots de ação por linha e botão de exclusão em massa.',
...
/** @type {[typeof BaseTable, ]} */ // @ts-ignore
...
var __VLS_43;
var __VLS_40;
/** @type {__VLS_StyleScopedClasses['p-8']} */ /** @type {__VLS_StyleScopedClasses['space-y-10']} */ /** @type {__VLS_StyleScopedClasses['text-2xl']} */ /** @type {__VLS_StyleScopedClasses['text-white']} */ /** @type {__VLS_StyleScopedClasses['font-bold']} */ /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-outline']} */ /** @type {__VLS_StyleScopedClasses['text-green-400']} */ /** @type {__VLS_StyleScopedClasses['font-bold']} */ /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['items-center']} */ /** @type {__VLS_StyleScopedClasses['gap-2']} */ /** @type {__VLS_StyleScopedClasses['text-white']} */ /** @type {__VLS_StyleScopedClasses['w-4']} */ /** @type {__VLS_StyleScopedClasses['h-4']} */ /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['items-center']} */ /** @type {__VLS_StyleScopedClasses['gap-3']} */ /** @type {__VLS_StyleScopedClasses['w-8']} */ /** @type {__VLS_StyleScopedClasses['h-8']} */ /** @type {__VLS_StyleScopedClasses['rounded-full']} */ /** @type {__VLS_StyleScopedClasses['relative']} */ /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-sm']} */ var __VLS_dollars;
