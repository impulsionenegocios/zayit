<template>
  <section class="p-8 space-y-10">
    <h1 class="text-2xl text-white font-bold">🔔 Toast Notifications</h1>
    ...
    >
      <div class="space-x-2">
        ...
        <button @click="toast.error('Ocorreu um erro inesperado!')" class="btn-toast btn-toast-red">
          Erro
        </button>
        <button
          @click="toast.info('Essa é uma informação importante.')"
          class="btn-toast btn-toast-blue"
        >
          Info
        </button>
        <button
          @click="toast.warning('Atenção: algo requer cuidado.')"
