...
const __VLS_0 = __VLS_asFunctionalComponent(
  ...
  new DocBlock({
    ...
    description:
      'O envio só acontece quando você chamar manualmente `uploadAll()` ou submeter o formulário.',
...
const __VLS_6 = __VLS_asFunctionalComponent(
  ...
  new DocBlock({
    ...
    description:
      'Assim que a imagem for selecionada, ela será automaticamente compactada e enviada para o backend.',
