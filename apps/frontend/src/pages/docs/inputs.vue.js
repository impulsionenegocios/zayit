...
const baseSelectCode =
  '<BaseSelect v-model="usuario" :options="opcoes" placeholder="Selecione um usuário" />';
const baseComboboxCode =
  '<BaseCombobox v-model="usuario" :options="opcoes" placeholder="Filtre um usuário..." />';
const baseTextareaCode =
  '<BaseTextarea v-model="observacao" :rows="3" :maxlength="200" autogrow />';
...
/** @type {[typeof BaseCombobox, ]} */ // @ts-ignore
...
/** @type {[typeof BaseSwitch, ]} */ // @ts-ignore
...
var __VLS_35;
var __VLS_2;
/** @type {__VLS_StyleScopedClasses['p-8']} */ /** @type {__VLS_StyleScopedClasses['space-y-10']} */ /** @type {__VLS_StyleScopedClasses['bg-surface']} */ /** @type {__VLS_StyleScopedClasses['min-h-screen']} */ /** @type {__VLS_StyleScopedClasses['text-2xl']} */ /** @type {__VLS_StyleScopedClasses['text-white']} */ /** @type {__VLS_StyleScopedClasses['font-bold']} */ var __VLS_dollars;
