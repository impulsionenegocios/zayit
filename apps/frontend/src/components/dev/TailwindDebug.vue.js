...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "drag-ghost bg-zayit-info bg-zayit-blue bg-zayit-warning px-0 px-1 px-2 px-3 px-4 px-5 px-6 px-8 px-10 grid-cols-1 grid-cols-2 grid-cols-3 grid-cols-4 grid-cols-5 grid-cols-6 sm:grid-cols-1 sm:grid-cols-2 sm:grid-cols-3 sm:grid-cols-4 sm:grid-cols-5 sm:grid-cols-6 md:grid-cols-1 md:grid-cols-2 md:grid-cols-3 md:grid-cols-4 md:grid-cols-5 md:grid-cols-6 lg:grid-cols-1 lg:grid-cols-2 lg:grid-cols-3 lg:grid-cols-4 lg:grid-cols-5 lg:grid-cols-6 xl:grid-cols-1 xl:grid-cols-2 xl:grid-cols-3 xl:grid-cols-4 xl:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-1 2xl:grid-cols-2 2xl:grid-cols-3 2xl:grid-cols-4 2xl:grid-cols-5 2xl:grid-cols-6" },
});
/** @type {__VLS_StyleScopedClasses['hidden']} */ ;
/** @type {__VLS_StyleScopedClasses['drag-ghost']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-zayit-info']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-zayit-blue']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-zayit-warning']} */ ;
...
/** @type {__VLS_StyleScopedClasses['xl:grid-cols-1']} */ ;
...
/** @type {__VLS_StyleScopedClasses['2xl:grid-cols-1']} */ ;
/** @type {__VLS_StyleScopedClasses['2xl:grid-cols-2']} */ ;
...
/** @type {__VLS_StyleScopedClasses['2xl:grid-cols-6']} */ ;
var __VLS_dollars;
