...
for (const [item, index] of __VLS_getVForSourceType((__VLS_ctx.menuItems))) {
    ...
    if (!item.subitems) {
        ...
        __VLS_asFunctionalDirective(__VLS_directives.vShow)(null, { ...__VLS_directiveBindingRestFields, value: (item.dropdownOpen) }, null, null);
...
/** @type {__VLS_StyleScopedClasses['2xl:w-76']} */ ;
...
/** @type {__VLS_StyleScopedClasses['space-y-2']} */ ;
/** @type {__VLS_StyleScopedClasses['ml-11']} */ ;
/** @type {__VLS_StyleScopedClasses['flex']} */ ;
/** @type {__VLS_StyleScopedClasses['items-center']} */ ;
/** @type {__VLS_StyleScopedClasses['p-2']} */ ;
