...
export default ((__VLS_props, __VLS_ctx, __VLS_expose, __VLS_setup = (async () => {
    ...
    const filteredData = computed(() => {
        if (!props.items)
            return [];
        return props.items.filter((item) => JSON.stringify(item).toLowerCase().includes(search.value.toLowerCase()));
    });
    // Paginação
    const pagina = ref(1);
    ...
    const isAllSelected = computed(() => !!(paginaAtual.value.length &&
    ...
    // @ts-ignore
    const __VLS_0 = __VLS_asFunctionalComponent(BaseCheckbox, new BaseCheckbox({
        ...{ 'onUpdate:modelValue': {} },
    ...
    if (__VLS_ctx.loading) {
        ...
        for (const [item] of __VLS_getVForSourceType((__VLS_ctx.paginaAtual))) {
            ...
            /** @type {[typeof BaseCheckbox, ]} */ ;
            // @ts-ignore
            const __VLS_11 = __VLS_asFunctionalComponent(BaseCheckbox, new BaseCheckbox({
                ...{ 'onUpdate:modelValue': {} },
    ...
    /** @type {__VLS_StyleScopedClasses['accent-zayit-blue']} */ ;
    /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
    /** @type {__VLS_StyleScopedClasses['px-4']} */ ;
    /** @type {__VLS_StyleScopedClasses['py-3']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['btn']} */ ;
    // @ts-ignore
    var __VLS_9 = __VLS_8, __VLS_10 = __VLS_7, __VLS_20 = __VLS_19, __VLS_21 = __VLS_18, __VLS_23 = __VLS_22;
    var __VLS_dollars;
