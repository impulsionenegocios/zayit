...
async function addContact() {
    if (!newContact.type || !newContact.description)
        return;
    const contact = {
        id: Date.now().toString(),
        leadId: props.leadId,
...
// @ts-ignore
const __VLS_44 = __VLS_asFunctionalComponent(FormControl, new FormControl({
    label: "Add Comment",
}));
...
// @ts-ignore
const __VLS_47 = __VLS_asFunctionalComponent(BaseTextarea, new BaseTextarea({
...
if (__VLS_ctx.showContactModal) {
    ...
    /** @type {[typeof FormControl, typeof FormControl, ]} */ ;
    // @ts-ignore
    const __VLS_106 = __VLS_asFunctionalComponent(FormControl, new FormControl({
        label: "Contact Type",
    ...
    // @ts-ignore
    const __VLS_109 = __VLS_asFunctionalComponent(BaseSelect, new BaseSelect({
    ...
    /** @type {[typeof FormControl, typeof FormControl, ]} */ ;
    // @ts-ignore
    const __VLS_112 = __VLS_asFunctionalComponent(FormControl, new FormControl({
        label: "Date & Time",
    ...
    // @ts-ignore
    const __VLS_115 = __VLS_asFunctionalComponent(BaseInput, new BaseInput({
    ...
    /** @type {[typeof FormControl, typeof FormControl, ]} */ ;
    // @ts-ignore
    const __VLS_118 = __VLS_asFunctionalComponent(FormControl, new FormControl({
        label: "Description",
    ...
    /** @type {[typeof BaseTextarea, ]} */ ;
    // @ts-ignore
    const __VLS_121 = __VLS_asFunctionalComponent(BaseTextarea, new BaseTextarea({
...
if (__VLS_ctx.showTaskModal) {
    ...
    /** @type {[typeof FormControl, typeof FormControl, ]} */ ;
    // @ts-ignore
    const __VLS_124 = __VLS_asFunctionalComponent(FormControl, new FormControl({
        label: "Task Title",
        forLabel: "taskTitle",
    }));
    ...
    /** @type {[typeof BaseInput, ]} */ ;
    // @ts-ignore
    const __VLS_127 = __VLS_asFunctionalComponent(BaseInput, new BaseInput({
    ...
    /** @type {[typeof FormControl, typeof FormControl, ]} */ ;
    // @ts-ignore
    const __VLS_130 = __VLS_asFunctionalComponent(FormControl, new FormControl({
        label: "Due Date",
    ...
    /** @type {[typeof BaseInput, ]} */ ;
    // @ts-ignore
    const __VLS_133 = __VLS_asFunctionalComponent(BaseInput, new BaseInput({
...
if (__VLS_ctx.showFileModal) {
    ...
    // @ts-ignore
    const __VLS_136 = __VLS_asFunctionalComponent(BaseFileInput, new BaseFileInput({
        ref: "fileInputRef",
...
/** @type {__VLS_StyleScopedClasses['mr-2']} */ ;
/** @type {__VLS_StyleScopedClasses['text-white']} */ ;
/** @type {__VLS_StyleScopedClasses['hover:text-zayit-blue']} */ ;
...
/** @type {__VLS_StyleScopedClasses['hover:text-zayit-danger']} */ ;
