...
const filteredTags = computed(() => {
    ...
    return allTags.value.filter(tag => tag.name.toLowerCase().includes(q) && !props.modelValue.includes(tag.id));
});
...
if (__VLS_ctx.showDropdown && __VLS_ctx.filteredTags.length > 0) {
    ...
    for (const [tag] of __VLS_getVForSourceType((__VLS_ctx.filteredTags))) {
        ...
        /** @type {[typeof Tag, ]} */ ;
        // @ts-ignore
        const __VLS_19 = __VLS_asFunctionalComponent(Tag, new Tag({
            tag: (tag),
        }));
...
if (__VLS_ctx.showCreateModal) {
    ...
    // @ts-ignore
    const __VLS_30 = __VLS_asFunctionalComponent(BaseModal, new BaseModal({
        ...{ 'onClose': {} },
    ...
    /** @type {[typeof FormControl, typeof FormControl, ]} */ ;
    // @ts-ignore
    const __VLS_43 = __VLS_asFunctionalComponent(FormControl, new FormControl({
        label: "Tag Color",
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        ...{ style: ({ backgroundColor: __VLS_ctx.newTagColor, color: __VLS_ctx.getContrastColor(__VLS_ctx.newTagColor) }) },
    });
...
/** @type {__VLS_StyleScopedClasses['hover:bg-zayit-blue/30']} */ ;
