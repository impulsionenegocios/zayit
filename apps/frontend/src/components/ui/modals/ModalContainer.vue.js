...
if (__VLS_ctx.modals.length) {
    ...
    for (const [modal] of __VLS_getVForSourceType((__VLS_ctx.modals))) {
        ...
        /** @type {[typeof ModalInstanceProvider, typeof ModalInstanceProvider, ]} */ ;
        // @ts-ignore
        const __VLS_4 = __VLS_asFunctionalComponent(ModalInstanceProvider, new ModalInstanceProvider({
