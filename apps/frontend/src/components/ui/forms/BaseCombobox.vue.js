...
/** @type {typeof __VLS_ctx.wrapperRef} */ __VLS_asFunctionalElement(
  __VLS_intrinsicElements.div,
  __VLS_intrinsicElements.div,
)({
  ...{ class: 'relative' },
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
  ...
  ...{
    class:
      'w-full px-4 py-2 bg-surface text-white rounded-lg border border-gray-700 focus:outline-none focus:ring-zayit-blue',
  },
