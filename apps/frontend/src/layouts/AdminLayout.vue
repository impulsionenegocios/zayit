<template>
    <div>
      <!-- Botão de toggle fora do container com h-screen -->
      <button
        @click="toggleSidebar"
        aria-controls="default-sidebar"
        type="button"
        class="sm:hidden inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
      ...
      <div class="flex h-screen">
        <aside
          ...
          aria-label="Sidenav"
        >
          <div class="relative overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <!-- Botão de fechar para mobile -->
            <button
              @click="closeSidebar"
              class="sm:hidden absolute top-4 right-4 p-2 text-gray-500 hover:bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            >
        ...
        <!-- Conteúdo principal, com margem à esquerda para evitar sobreposição com a sidebar em telas maiores -->
        <div class="flex-1 overflow-y-auto sm:ml-64">
          <router-view />
        </div>
      </div>
    </div>
